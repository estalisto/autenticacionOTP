...
/**
 * Created by Stalyn on 20/07/2016.
 */


        import com.maite.org.maite.api.Base32;
        import com.maite.org.maite.api.Clock;
        import com.maite.org.maite.api.Digits;
        import com.maite.org.maite.api.Hash;
        import com.maite.org.maite.api.Hmac;
...
public class autenticacionOTP {
    ...
    public autenticacionOTP(String secret) {
        this.secret = secret;
        clock = new Clock();
    }
    ...
    public int generate2(String secret, long interval) {
        return hash(secret, interval);
    }
